...
import TestimonyCarousel from "../components/pages/home/TestimonyCarousel";
  ...
  return (
    ...
    <div>
      ...
      <div className="flex align-center flex-col gap-3 text-center">
        ...
        <div className="opacity-60 font-medium text-[14px] lg:text-[24px]">
          Kape ibarra est. 2024
        </div>

        <Button className="w-max self-center mt-7 lg:mt-10">
          Order yours now
        </Button>
      </div>
      ...
      <div className="flex justify-center mt-12">
        <Image
          src="/img/home/couple_of_coffees.png"
          alt="couple_coffees"
          width={1000}
          height={1000}
      ...
      <div className="grid gap-2 lg:gap-3 mt-24">
        <div className="grid grid-cols-1 lg:grid-cols-home_card gap-2 lg:gap-3">
          ...
          <Card
            text="Coffees are made from real coffee beans"
            img="/img/home/cards/bg.jpeg"
          />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 lg:gap-3 mt-24">
        <Card
          text="B6 L3 Sampaguita st. Residencia Regina, Loma De Gato"
          img="/img/home/loc_bg.jpeg"
        />
      ...
      {/* Testimonials */}
      <div className="flex align-center flex-col gap-3 text-center mt-12">
        <div className="font-playfair font-bold text-4xl lg:text-6xl">
          Testimonials
        </div>
        <div className="opacity-60 font-medium text-[14px] lg:text-[24px]">
      ...
      {/* <div className="grid grid-cols-testimony_card gap-2 lg:gap-3 mt-12">
...
const Card = ({ img, text }: { img?: string; text: string }) => {
  return (
    ...
    >
      <div
        className="absolute inset-0 bg-cover bg-center transition-transform duration-1000 ease-in-out transform group-hover:scale-110"
        style={img ? { backgroundImage: `url(${img})` } : null}
      ></div>
